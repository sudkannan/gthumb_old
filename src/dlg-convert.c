...
load_current_image (DialogData *data)
{
	...
	fprintf(stdout,"In dlg-convert.c load_current_image ... \n");	
				      ...
				      gpointer        callback_data)
{
	...
	//fprintf(stdout,"In dlg-convert.c save_image_and_remove_original_step2 ... \n");
...
save_image_and_remove_original (DialogData *data)
{
	...
	//fprintf(stdout,"In dlg-convert.c save_image_and_remove_original ... \n");
#ifndef USE_NVM
